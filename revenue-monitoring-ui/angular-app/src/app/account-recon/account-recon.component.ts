...
@Component({
  selector: 'app-account-recon',
  templateUrl: './account-recon.component.html',
  styleUrl: './account-recon.component.css',
  providers: [DestroyManager],
})
export class AccountReconComponent implements OnInit {
  roles: string[] = [];
  constructor(
