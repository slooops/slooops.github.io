...
import { MainSidebarNavComponent, NavItem } from './main-sidebar-nav.component';
import { NgIconsModule } from '@ng-icons/core';

describe('MainSidebarNavComponent', () => {
  let component: MainSidebarNavComponent;
  let fixture: ComponentFixture<MainSidebarNavComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [MainSidebarNavComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(MainSidebarNavComponent);
