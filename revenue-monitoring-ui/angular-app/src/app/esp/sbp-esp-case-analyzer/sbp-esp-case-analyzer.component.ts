...
export class SbpEspCaseAnalyzerComponent implements OnInit {
  ...
  /**
   * Build quarter pairs using the "latest complete pair" logic.
   * For Q1-Q2, Q2-Q3, Q3-Q4: Find the latest fiscal year with both quarters.
   * For Q4-Q1: Find the latest year Y where Q4FY(Y-1) and Q1FY(Y) both exist.
   *
   * Example A (Mixed FY25/FY26 data):
   *   Input: Q1FY25, Q2FY25, Q3FY25, Q4FY25, Q1FY26, Q2FY26
   *   Output:
   *   - Q1-Q2: Q1FY26 vs Q2FY26
   *   - Q2-Q3: Q2FY25 vs Q3FY25
   *   - Q3-Q4: Q3FY25 vs Q4FY25
   *   - Q4-Q1: Q4FY25 vs Q1FY26
   *
   * Example B (FY26 complete, FY27 Q1 missing):
   *   Input: Q1FY26, Q2FY26, Q3FY26, Q4FY26
   *   Output:
   *   - Q1-Q2, Q2-Q3, Q3-Q4: FY26
   *   - Q4-Q1: Not available (Q1FY27 doesn't exist)
   *
   * Example C (Only Q1FY27 exists):
   *   Input: Q1FY27
   *   Output: No complete pairs
   *
