...
export class CaseiqOmComponent {
  metricTiles = [
  ...
  i2cChartData: StackedBarChartDataPoint[] = [
    {
      ...
      segments: [
        { name: 'Validated', value: 98, color: '#36A2EB' },
        { name: 'Incorrect/Not Validated', value: 134, color: '#E5E5E5' },
      ],
    },
    {
      label: 'Accounting',
      segments: [
        { name: 'Validated', value: 256, color: '#36A2EB' },
    ...
    },
    {
      ...
      segments: [
        ...
        { name: 'Incorrect/Not Validated', value: 189, color: '#E5E5E5' },
      ],
    },
    {
      label: 'Credit & Collections',
      segments: [
        { name: 'Validated', value: 423, color: '#36A2EB' },
    ...
    },
    {
      ...
      segments: [
        ...
        { name: 'Incorrect/Not Validated', value: 245, color: '#E5E5E5' },
      ],
    },
    {
      label: 'Invoicing',
      segments: [
        { name: 'Validated', value: 567, color: '#36A2EB' },
    ...
    },
    {
      ...
      segments: [
        ...
        { name: 'Incorrect/Not Validated', value: 312, color: '#E5E5E5' },
      ],
    },
  ];
  ...
  i2cSimpleChartData: BarChartDataPoint[] = [
    { label: 'E-Invoicing - Esker', value: 678, color: '#E5E5E5' },
    { label: 'E-Invoicing - Sovos', value: 234, color: '#E5E5E5' },
    { label: 'E-Invoicing - Synchro', value: 567, color: '#E5E5E5' },
    { label: 'E-Invoicing - IRN', value: 123, color: '#E5E5E5' },
    { label: 'Invoice Amount', value: 789, color: '#E5E5E5' },
    { label: 'Invoice Amount', value: 456, color: '#E5E5E5' },
    { label: 'Invoice Enquiry Tax', value: 234, color: '#E5E5E5' },
    { label: 'Invoice Aging', value: 890, color: '#E5E5E5' },
    { label: 'Invoice Delivery - Email', value: 67, color: '#E5E5E5' },
    { label: 'Invoice Delivery B2B', value: 345, color: '#E5E5E5' },
    { label: 'Invoice Not Generated', value: 678, color: '#E5E5E5' },
    { label: 'Post Invoice Dispute', value: 156, color: '#E5E5E5' },
    { label: 'Receipts', value: 523, color: '#E5E5E5' },
  ];
