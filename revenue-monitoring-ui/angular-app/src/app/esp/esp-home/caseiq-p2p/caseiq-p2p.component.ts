...
export class CaseiqP2pComponent {
  metricTiles = [
  ...
  i2cChartData: StackedBarChartDataPoint[] = [
    ...
    },
    {
      ...
      segments: [
        ...
        { name: 'Incorrect/Not Validated', value: 167, color: '#E5E5E5' },
      ],
    },
    {
      label: 'Cash Apps',
  ...
  i2cSimpleChartData: BarChartDataPoint[] = [
    { label: 'E-Invoicing - Esker', value: 345, color: '#E5E5E5' },
    { label: 'E-Invoicing - Sovos', value: 789, color: '#E5E5E5' },
    { label: 'E-Invoicing - Synchro', value: 156, color: '#E5E5E5' },
    { label: 'E-Invoicing - IRN', value: 523, color: '#E5E5E5' },
    { label: 'Invoice Amount', value: 267, color: '#E5E5E5' },
    { label: 'Invoice Amount', value: 678, color: '#E5E5E5' },
    { label: 'Invoice Enquiry Tax', value: 134, color: '#E5E5E5' },
    { label: 'Invoice Aging', value: 445, color: '#E5E5E5' },
    { label: 'Invoice Delivery - Email', value: 298, color: '#E5E5E5' },
    { label: 'Invoice Delivery B2B', value: 612, color: '#E5E5E5' },
    { label: 'Invoice Not Generated', value: 189, color: '#E5E5E5' },
    { label: 'Post Invoice Dispute', value: 734, color: '#E5E5E5' },
    { label: 'Receipts', value: 356, color: '#E5E5E5' },
  ];
