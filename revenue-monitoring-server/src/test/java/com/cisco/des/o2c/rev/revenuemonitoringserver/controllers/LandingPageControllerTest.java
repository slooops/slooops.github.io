...
class LandingPageControllerTest {
    ...
    @MockBean
    LandingContextService contextService;

    @Test
    void getLandingPagePeriodData() throws Exception {
    ...
    @Test
    void getLandingPageIssues() throws Exception {
    ...
    @Test
    void getLandingPageHighPriorityIssues() throws Exception {
    ...
    @Test
    void getLandingPageIssuesList() throws Exception {
    ...
    @Test
    void getLandingPageIssuesDistribution() throws Exception {
    ...
    @Test
    void getLandingPageTransactionFailures() throws Exception {
    ...
    @Test
    void getLandingPageEspCases() throws Exception {
