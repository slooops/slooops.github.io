...
public class RolTransactionData {
    ...
    public void setERROR_APPLICATION(String ERROR_APPLICATION) {
    ...
    public void setORDERNUMBER_CUSTTRXID(String ORDERNUMBER_CUSTTRXID) {
        this.ORDERNUMBER_CUSTTRXID = ORDERNUMBER_CUSTTRXID;
    }

    public void setCUSTTRXLINEID(String CUSTTRXLINEID) {
    ...
    public String getERROR_APPLICATION() {
