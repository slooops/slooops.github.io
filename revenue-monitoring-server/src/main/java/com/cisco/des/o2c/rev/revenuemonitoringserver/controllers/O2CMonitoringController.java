...
public class O2CMonitoringController {
    ...
    public ResponseEntity<List<Map<String, Object>>> getSubscriptionSummary(@RequestParam List<String> subRefIds,
            @RequestParam List<String> subCodes) {
        try {
            List<Map<String, Object>> details = new ArrayList<>();
    ...
    public ResponseEntity<List<Map<String, Object>>> getSbpBillScheduleLines(@RequestParam List<String> offsetId,
            @RequestParam List<String> billDate) {
        try {
            List<Map<String, Object>> details = new ArrayList<>();
    ...
    public ResponseEntity<List<Map<String, Object>>> getTsvTopSku(@RequestParam String subscriptionIds,
            @RequestParam String webOrderLineIds) {
        try {
            List<Map<String, Object>> details = new ArrayList<>();
    ...
    public ResponseEntity<List<Map<String, Object>>> getTsvSubSku(@RequestParam String subscriptionIds,
            @RequestParam String webOrderLineIds) {
        try {
            List<Map<String, Object>> details = new ArrayList<>();
    ...
    public ResponseEntity<List<Map<String, Object>>> getTsvAccounts(@RequestParam String subscriptionIds,
            @RequestParam String webOrderLineIds) {
        try {
            List<Map<String, Object>> details = new ArrayList<>();
