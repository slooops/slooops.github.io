...
3. **Behaviour-shifter predictions fired during Q4 close.** During Jul 22–Aug 4, several typically-CaseIQ users (e.g., SUNITH, SAI) show CTX1 visit spikes 2–3 days *before* the official close window opened, matching the engine's exponential-decay design.
